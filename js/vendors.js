...
var ACTIVEINDEX = 0;
let ITEMLIST = document.querySelectorAll('.slider__item');
...
ChiefSlider.prototype._setActiveClass = function() {
  ...
  for (var t = this._activeItems, i = this._$itemList, e = 0, s = i.length; e < s; e++) {
    ...
    i[e].style.minWidth ="166px";

    if (t.indexOf(a) > -1) {
      r.classList.add(CLASS_ITEM_ACTIVE)
      r.classList.remove("prev")
...
ChiefSlider.prototype._move = function() {
  ...
  this._$items.style.transform = 'translateX(' + (transform * 1.4065) + '%)';
