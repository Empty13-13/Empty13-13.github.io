 ...
 */
    ...
    (() => {
        ...
        function honeycombAnimation() {
            let w = c.width = window.innerWidth, h = c.height = window.innerHeight, ctx = c.getContext("2d"), opts = {
                len: 100,
                count: 100,
                baseTime: 10,
                addedTime: 120,
                ...
                repaintAlpha: .04,
                hueChange: .1
            }, tick = 0, lines = [], dieX = w / 2 / opts.len, dieY = h / 2 / opts.len, baseRad = 2 * Math.PI / 6;
            ctx.fillStyle = "black";
            ...
            Line.prototype.reset = function() {
                ...
                opts.isFirstColor = !opts.isFirstColor;
                if (opts.isFirstColor) this.color = opts.color.replace("hue", "270"); else this.color = opts.color.replace("hue", "38");
            ...
            Line.prototype.step = function() {
                ...
                let prop = this.time / this.targetTime, wave = Math.sin(prop * Math.PI / 2), x = this.addedX * wave, y = this.addedY * wave;
