...
ChiefSlider.prototype._addEventListener = function () {
  ...
  this._activeItems = n, this._setActiveClass(), this._updateIndicators(), this._transform = i, this._$items.style.transform = "translateX(" + (i * 1.4) + "%)", this._$items.dispatchEvent(new CustomEvent("transition-start", {bubbles: !0}))
